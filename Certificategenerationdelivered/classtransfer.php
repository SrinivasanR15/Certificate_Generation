...
<form action="certification.php" name="certificationdetails"  id="certificationdetails"  method="post">
	<table border="2" cellspacing="6" class="displaycontent" width="800" style="border:10px black;" align="center">
	<caption></caption>
	<tr><h2 align="center"><br/>TRANSFER CERTIFICATE DELIVERED DETAILS </h2>
<br/><br/>
	<center >
	<tr>
	 		<th bgcolor=Green><font color=white size=2>Delivered Date:</font></th>
			
	</tr>
<?php
$query="select * from deliveredtc where Regno='".$_POST['Regno']."'";
$result1=mysql_query($query);
while($row = mysql_fetch_assoc($result1))
		{
 ?>
...
<table border="2" cellspacing="6" class="displaycontent" width="800" style="border:10px black;" align="center">
	<caption></caption>
	<tr><h2 align="center"><br/>COURSE CERTIFICATE DELIVERED DETAILS </h2>
<br/><br/>
	<center >
	<tr>
	 		<th bgcolor=Green><font color=white size=2>Delivered Date:</font></th>
...
<?php
$query="select * from deliveredcc where Regno='".$_POST['Regno']."'";
$result1=mysql_query($query);
while($row = mysql_fetch_assoc($result1))
		{
 ?>
